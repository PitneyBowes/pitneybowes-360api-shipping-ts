...
export const server1 = new ServerConfiguration<{  }>("https://api-sandbox.sendpro360.pitneybowes.com/shipping", {  })
export const server2 = new ServerConfiguration<{  }>("https://api.sendpro360.pitneybowes.com/shipping", {  })
