...
*/
export class SingleRateResponseParcel {
    /**
    ...
    */
    'dimUnit': SingleRateResponseParcelDimUnitEnum;
    /**
    * WeightUnit is a standard for measuring the physical quantities of specified weight.
    */
    'weightUnit': SingleRateResponseParcelWeightUnitEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "dimUnit",
            "baseName": "dimUnit",
            "type": "SingleRateResponseParcelDimUnitEnum",
            "format": ""
        },
        {
            "name": "weightUnit",
            "baseName": "weightUnit",
            "type": "SingleRateResponseParcelWeightUnitEnum",
            "format": ""
        },
        {
            "name": "weight",
    ...
    static getAttributeTypeMap() {
        return SingleRateResponseParcel.attributeTypeMap;
    }
...
export enum SingleRateResponseParcelDimUnitEnum {
    In = 'IN'
}
export enum SingleRateResponseParcelWeightUnitEnum {
    Oz = 'OZ'
}
