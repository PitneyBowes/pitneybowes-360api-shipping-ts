...
export class GetAllShipmentsDataInnerParcel {
    /**
    ...
    */
    'dimUnit': GetAllShipmentsDataInnerParcelDimUnitEnum;
    /**
    * WeightUnit is a standard for measuring the physical quantities of specified weight.
    */
    'weightUnit': GetAllShipmentsDataInnerParcelWeightUnitEnum;
    'weight': number;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "dimUnit",
            "baseName": "dimUnit",
            "type": "GetAllShipmentsDataInnerParcelDimUnitEnum",
            "format": ""
        },
        {
            "name": "weightUnit",
            "baseName": "weightUnit",
            "type": "GetAllShipmentsDataInnerParcelWeightUnitEnum",
            "format": ""
        },
        {
            "name": "weight",
    ...
    static getAttributeTypeMap() {
        return GetAllShipmentsDataInnerParcel.attributeTypeMap;
    }
...
export enum GetAllShipmentsDataInnerParcelDimUnitEnum {
    In = 'IN'
}
export enum GetAllShipmentsDataInnerParcelWeightUnitEnum {
    Oz = 'OZ'
}
