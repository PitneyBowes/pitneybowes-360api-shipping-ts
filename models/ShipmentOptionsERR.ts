...
export class ShipmentOptionsERR {
    /**
    ...
    */
    'receiptOption'?: ShipmentOptionsERRReceiptOptionEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "printCustomMessage",
            "baseName": "printCustomMessage",
            "type": "string",
            "format": ""
        },
        {
            "name": "receiptOption",
            "baseName": "receiptOption",
            "type": "ShipmentOptionsERRReceiptOptionEnum",
            "format": ""
        },
        {
            "name": "printDepartment",
            "baseName": "printDepartment",
            "type": "string",
            "format": ""
        },
        {
            "name": "printInvoiceNumber",
            "baseName": "printInvoiceNumber",
            "type": "string",
            "format": ""
        },
        {
            "name": "printPONumber",
            "baseName": "printPONumber",
            "type": "string",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ShipmentOptionsERR.attributeTypeMap;
    }
...
export enum ShipmentOptionsERRReceiptOptionEnum {
    ReceiptOnly = 'RECEIPT_ONLY',
    ReceiptWithInstructions = 'RECEIPT_WITH_INSTRUCTIONS',
