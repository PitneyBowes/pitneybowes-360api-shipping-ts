...
export class GetRates200Response {
    'fromAddress'?: RateShopResponseFromAddress;
    'parcel'?: RateShopResponseParcel;
    /**
    * It displays all available rates for each services
    */
    'rates'?: Array<RateShopResponseRatesInner>;
    'toAddress'?: RateShopResponseToAddress;
    /**
    ...
    */
    'errors'?: Array<RateShopResponseErrorsInner>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            ...
            "type": "RateShopResponseFromAddress",
            "format": ""
        },
        {
            "name": "parcel",
            "baseName": "parcel",
            "type": "RateShopResponseParcel",
            "format": ""
        },
        {
            "name": "rates",
            "baseName": "rates",
            "type": "Array<RateShopResponseRatesInner>",
            "format": ""
        },
        {
            "name": "toAddress",
            "baseName": "toAddress",
            "type": "RateShopResponseToAddress",
            "format": ""
        },
        {
            "name": "isHazmat",
        ...
        },
        {
            "name": "errors",
            "baseName": "errors",
            "type": "Array<RateShopResponseErrorsInner>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return GetRates200Response.attributeTypeMap;
    }
