...
*/
export class RateShopResponseParcel {
    /**
    ...
    */
    'dimUnit': RateShopResponseParcelDimUnitEnum;
    /**
    * WeightUnit is a standard for measuring the physical quantities of specified weight.
    */
    'weightUnit': RateShopResponseParcelWeightUnitEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "dimUnit",
            "baseName": "dimUnit",
            "type": "RateShopResponseParcelDimUnitEnum",
            "format": ""
        },
        {
            "name": "weightUnit",
            "baseName": "weightUnit",
            "type": "RateShopResponseParcelWeightUnitEnum",
            "format": ""
        },
        {
            "name": "weight",
    ...
    static getAttributeTypeMap() {
        return RateShopResponseParcel.attributeTypeMap;
    }
...
export enum RateShopResponseParcelDimUnitEnum {
    In = 'IN'
}
export enum RateShopResponseParcelWeightUnitEnum {
    Oz = 'OZ'
}
