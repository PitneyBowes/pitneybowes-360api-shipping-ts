...
export class ShipmentDomesticParcel {
    /**
    ...
    */
    'dimUnit': ShipmentDomesticParcelDimUnitEnum;
    /**
    * WeightUnit is a standard for measuring the physical quantities of specified weight.
    */
    'weightUnit': ShipmentDomesticParcelWeightUnitEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "dimUnit",
            "baseName": "dimUnit",
            "type": "ShipmentDomesticParcelDimUnitEnum",
            "format": ""
        },
        {
            "name": "weightUnit",
            "baseName": "weightUnit",
            "type": "ShipmentDomesticParcelWeightUnitEnum",
            "format": ""
        },
        {
            "name": "weight",
    ...
    static getAttributeTypeMap() {
        return ShipmentDomesticParcel.attributeTypeMap;
    }
...
export enum ShipmentDomesticParcelDimUnitEnum {
    In = 'IN'
}
export enum ShipmentDomesticParcelWeightUnitEnum {
    Oz = 'OZ'
}
