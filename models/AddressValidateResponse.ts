...
export class AddressValidateResponse {
    /**
    ...
    */
    'status'?: AddressValidateResponseStatusEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "AddressValidateResponseStatusEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return AddressValidateResponse.attributeTypeMap;
    }
...
export enum AddressValidateResponseStatusEnum {
