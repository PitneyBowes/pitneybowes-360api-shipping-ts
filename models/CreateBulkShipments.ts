    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "size",
            "baseName": "size",
            "type": "CreateBulkShipmentsSizeEnum",
            "format": ""
        },
        {
            "name": "type",
        ...
        },
        {
            "name": "format",
            "baseName": "format",
            "type": "CreateBulkShipmentsFormatEnum",
            "format": ""
        },
        {
            "name": "name",
    ...
    static getAttributeTypeMap() {
        return CreateBulkShipments.attributeTypeMap;
    }
...
export enum CreateBulkShipmentsSizeEnum {
    _8X11 = 'DOC_8X11',
    _4X6 = 'DOC_4X6'
}
export enum CreateBulkShipmentsTypeEnum {
    ShippingLabel = 'SHIPPING_LABEL'
}
export enum CreateBulkShipmentsFormatEnum {
    Pdf = 'PDF'
}
