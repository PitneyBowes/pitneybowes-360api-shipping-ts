...
export class CreateShipmentV2Request {
    ...
    */
    'rateShopBy': CreateShipmentV2RequestRateShopByEnum;
    'byCarrier'?: ByCarrierV2;
    ...
    */
    'deliveryConfirmation'?: CreateShipmentV2RequestDeliveryConfirmationEnum;
    /**
    ...
    */
    'handling'?: CreateShipmentV2RequestHandlingEnum;
    /**
    ...
    */
    'insurance'?: CreateShipmentV2RequestInsuranceEnum;
    ...
    */
    'labelSize': CreateShipmentV2RequestLabelSizeEnum;
    /**
    * Defines the type of the Shipment. <br /> `Max length = 14`
    */
    'labelType': CreateShipmentV2RequestLabelTypeEnum;
    /**
    * Defines the file/format in which the label is printed. <br /> `Max length = 14`
    */
    'labelFormat': CreateShipmentV2RequestLabelFormatEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "rateShopBy",
            "baseName": "rateShopBy",
            "type": "CreateShipmentV2RequestRateShopByEnum",
            "format": ""
        },
        {
            "name": "byCarrier",
        ...
        },
        {
            ...
            "type": "CreateShipmentV2RequestDeliveryConfirmationEnum",
            "format": ""
        },
        {
            "name": "handling",
            "baseName": "handling",
            "type": "CreateShipmentV2RequestHandlingEnum",
            "format": ""
        },
        {
            "name": "insurance",
            "baseName": "insurance",
            "type": "CreateShipmentV2RequestInsuranceEnum",
            "format": ""
        },
        {
            "name": "references",
        ...
        },
        {
            "name": "labelSize",
            "baseName": "labelSize",
            "type": "CreateShipmentV2RequestLabelSizeEnum",
            "format": ""
        },
        {
            "name": "labelType",
            "baseName": "labelType",
            "type": "CreateShipmentV2RequestLabelTypeEnum",
            "format": ""
        },
        {
            "name": "labelFormat",
            "baseName": "labelFormat",
            "type": "CreateShipmentV2RequestLabelFormatEnum",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return CreateShipmentV2Request.attributeTypeMap;
    }
...
export enum CreateShipmentV2RequestRateShopByEnum {
    Carrier = 'carrier',
    RateGroup = 'rateGroup',
    Ruleset = 'ruleset'
}
export enum CreateShipmentV2RequestDeliveryConfirmationEnum {
    Sig = 'SIG',
    Sighc = 'SIGHC',
    DelCon = 'DEL_CON',
    AdultSig = 'ADULT_SIG',
...
export enum CreateShipmentV2RequestHandlingEnum {
    Hold = 'HOLD',
...
export enum CreateShipmentV2RequestInsuranceEnum {
    Ins = 'INS'
}
export enum CreateShipmentV2RequestLabelSizeEnum {
    _8X11 = 'DOC_8X11',
    _4X8 = 'DOC_4X8',
    _4X6 = 'DOC_4X6'
}
export enum CreateShipmentV2RequestLabelTypeEnum {
    ShippingLabel = 'SHIPPING_LABEL'
}
export enum CreateShipmentV2RequestLabelFormatEnum {
    Zpl2 = 'ZPL2',
    Pdf = 'PDF'
}
