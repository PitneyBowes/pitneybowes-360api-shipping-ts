...
export class SingleRateResponse {
    'fromAddress'?: SingleRateResponseFromAddress;
    'parcel'?: SingleRateResponseParcel;
    /**
    * It displays the rate for the required carrier-service and/or special service combinaion
    */
    'rates'?: Array<SingleRateResponseRatesInner>;
    'toAddress'?: SingleRateResponseToAddress;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            ...
            "type": "SingleRateResponseFromAddress",
            "format": ""
        },
        {
            "name": "parcel",
            "baseName": "parcel",
            "type": "SingleRateResponseParcel",
            "format": ""
        },
        {
            "name": "rates",
            "baseName": "rates",
            "type": "Array<SingleRateResponseRatesInner>",
            "format": ""
        },
        {
            "name": "toAddress",
            "baseName": "toAddress",
            "type": "SingleRateResponseToAddress",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return SingleRateResponse.attributeTypeMap;
    }
