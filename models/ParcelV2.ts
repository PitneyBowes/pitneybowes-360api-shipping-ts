...
export class ParcelV2 {
    ...
    */
    'weightUnit': ParcelV2WeightUnitEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "dimUnit",
            "baseName": "dimUnit",
            "type": "ParcelV2DimUnitEnum",
            "format": ""
        },
        {
            "name": "weightUnit",
            "baseName": "weightUnit",
            "type": "ParcelV2WeightUnitEnum",
            "format": ""
        },
        {
            "name": "weight",
    ...
    static getAttributeTypeMap() {
        return ParcelV2.attributeTypeMap;
    }
...
export enum ParcelV2DimUnitEnum {
    In = 'IN',
    Cm = 'CM'
}
export enum ParcelV2WeightUnitEnum {
    Oz = 'OZ',
    Gm = 'GM'
}
