...
*/
export class ShipmentDomesticByCarrierDeliveryOption {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "useBestNextDate",
            "baseName": "useBestNextDate",
            "type": "boolean",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ShipmentDomesticByCarrierDeliveryOption.attributeTypeMap;
    }
