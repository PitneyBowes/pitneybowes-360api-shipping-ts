...
export class SchedulePickupUPSResponsePickupSummaryInner {
    /**
    * The service id
    */
    'serviceId'?: string;
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "baseName": "toAddressCountryCode",
            "type": "string",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return SchedulePickupUPSResponsePickupSummaryInner.attributeTypeMap;
    }
