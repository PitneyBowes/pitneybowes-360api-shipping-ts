...
*/
export class ShipmentDomesticByRateGroupByRateGroup {
    /**
    ...
    */
    'ruleType': ShipmentDomesticByRateGroupByRateGroupRuleTypeEnum;
    /**
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "ruleType",
            "baseName": "ruleType",
            "type": "ShipmentDomesticByRateGroupByRateGroupRuleTypeEnum",
            "format": ""
        },
        {
            "name": "rateGroupId",
            "baseName": "rateGroupId",
            "type": "string",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ShipmentDomesticByRateGroupByRateGroup.attributeTypeMap;
    }
...
export enum ShipmentDomesticByRateGroupByRateGroupRuleTypeEnum {
    Cheapest = 'Cheapest',
    Fastest = 'Fastest',
    DeliverBy = 'DeliverBy'
}
