...
export class CreateShipmentRequest {
    ...
    */
    'size': CreateShipmentRequestSizeEnum;
    /**
    ...
    */
    'format'?: CreateShipmentRequestFormatEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "size",
            "baseName": "size",
            "type": "CreateShipmentRequestSizeEnum",
            "format": ""
        },
        {
            "name": "type",
        ...
        },
        {
            "name": "format",
            "baseName": "format",
            "type": "CreateShipmentRequestFormatEnum",
            "format": ""
        },
        {
            "name": "dateOfShipment",
    ...
    static getAttributeTypeMap() {
        return CreateShipmentRequest.attributeTypeMap;
    }
...
export enum CreateShipmentRequestSizeEnum {
    Doc8X11 = 'DOC_8X11'
}
export enum CreateShipmentRequestTypeEnum {
    ShippingLabel = 'SHIPPING_LABEL'
}
export enum CreateShipmentRequestFormatEnum {
    Pdf = 'PDF',
    Zpl2 = 'ZPL2'
}
