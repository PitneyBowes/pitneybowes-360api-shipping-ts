...
export class ReturnLabel {
    ...
    */
    'size'?: ReturnLabelSizeEnum;
    /**
    * This defines the type of the Shipment, e.g., Shipping Label.
    */
    'type'?: ReturnLabelTypeEnum;
    'fromAddress'?: ReturnLabelFromAddress;
    ...
    */
    'serviceId'?: string;
    'specialServices'?: Array<ReturnLabelSpecialServicesInner>;
    ...
    */
    ...
    'toAddress'?: ReturnLabelToAddress;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "Array<ReturnLabelSpecialServicesInner>",
            "format": ""
        },
        {
        ...
        },
        {
            "name": "toAddress",
            "baseName": "toAddress",
            "type": "ReturnLabelToAddress",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ReturnLabel.attributeTypeMap;
    }
...
export enum ReturnLabelSizeEnum {
    Doc8X11 = 'DOC_8X11'
}
export enum ReturnLabelTypeEnum {
