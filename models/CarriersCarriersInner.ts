...
export class CarriersCarriersInner {
    /**
    ...
    */
    ...
    'properties'?: CarriersCarriersInnerProperties;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "properties",
            "baseName": "properties",
            "type": "CarriersCarriersInnerProperties",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return CarriersCarriersInner.attributeTypeMap;
    }
