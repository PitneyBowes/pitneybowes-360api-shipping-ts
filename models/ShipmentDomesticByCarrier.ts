...
export class ShipmentDomesticByCarrier {
    ...
    */
    'rateShopBy': ShipmentDomesticByCarrierRateShopByEnum;
    'byCarrier'?: ByCarrierV2;
    'shipmentOptions'?: ShipmentDomesticByCarrierShipmentOptions;
    ...
    */
    'deliveryConfirmation'?: ShipmentDomesticByCarrierDeliveryConfirmationEnum;
    /**
    ...
    */
    'handling'?: ShipmentDomesticByCarrierHandlingEnum;
    /**
    ...
    */
    'insurance'?: ShipmentDomesticByCarrierInsuranceEnum;
    ...
    */
    'labelFormat': ShipmentDomesticByCarrierLabelFormatEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "rateShopBy",
            "baseName": "rateShopBy",
            "type": "ShipmentDomesticByCarrierRateShopByEnum",
            "format": ""
        },
        {
            "name": "byCarrier",
        ...
        },
        {
            ...
            "type": "ShipmentDomesticByCarrierShipmentOptions",
            "format": ""
        },
        {
            "name": "docTab",
        ...
        },
        {
            ...
            "type": "ShipmentDomesticByCarrierDeliveryConfirmationEnum",
            "format": ""
        },
        {
            "name": "handling",
            "baseName": "handling",
            "type": "ShipmentDomesticByCarrierHandlingEnum",
            "format": ""
        },
        {
            "name": "insurance",
            "baseName": "insurance",
            "type": "ShipmentDomesticByCarrierInsuranceEnum",
            "format": ""
        },
        {
            "name": "references",
        ...
        },
        {
            "name": "metadata",
            "baseName": "metadata",
            "type": "Array<ShipmentDomesticByCarrierMetadataInner>",
            "format": ""
        },
        {
            "name": "labelSize",
            "baseName": "labelSize",
            "type": "ShipmentDomesticByCarrierLabelSizeEnum",
            "format": ""
        },
        {
            "name": "labelType",
            "baseName": "labelType",
            "type": "ShipmentDomesticByCarrierLabelTypeEnum",
            "format": ""
        },
        {
            "name": "labelFormat",
            "baseName": "labelFormat",
            "type": "ShipmentDomesticByCarrierLabelFormatEnum",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return ShipmentDomesticByCarrier.attributeTypeMap;
    }
...
export enum ShipmentDomesticByCarrierRateShopByEnum {
    Carrier = 'carrier',
    RateGroup = 'rateGroup',
    Ruleset = 'ruleset'
}
export enum ShipmentDomesticByCarrierDeliveryConfirmationEnum {
    Sig = 'SIG',
    Sighc = 'SIGHC',
    DelCon = 'DEL_CON',
    AdultSig = 'ADULT_SIG',
...
export enum ShipmentDomesticByCarrierHandlingEnum {
    Hold = 'HOLD',
...
export enum ShipmentDomesticByCarrierInsuranceEnum {
    Ins = 'INS'
}
export enum ShipmentDomesticByCarrierLabelSizeEnum {
    _8X11 = 'DOC_8X11',
    _4X8 = 'DOC_4X8',
    _4X6 = 'DOC_4X6'
}
export enum ShipmentDomesticByCarrierLabelTypeEnum {
    ShippingLabel = 'SHIPPING_LABEL'
}
export enum ShipmentDomesticByCarrierLabelFormatEnum {
    Zpl2 = 'ZPL2',
    Pdf = 'PDF'
}
