...
export class SchedulePickupCancelRequest {
    /**
    ...
    */
    'options'?: Array<SchedulePickupCancelRequestOptionsInner>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "options",
            "baseName": "options",
            "type": "Array<SchedulePickupCancelRequestOptionsInner>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return SchedulePickupCancelRequest.attributeTypeMap;
    }
